...
public class StandalonePUNManager : MonoBehaviourPunCallbacks {
    ...
    private void Init () {
        ...
        list.Add (new Vector3 (-7, 1, -4));
        list.Add (new Vector3 (-8, 1, 0));
        list.Add (new Vector3 (-8, 1, 6));
        list.Add (new Vector3 (-1, 1, 7));
        list.Add (new Vector3 (-1, 1, -4));
        list.Add (new Vector3 (5, 1, 3));
        list.Add (new Vector3 (8, 1, 0));
        list.Add (new Vector3 (8, 1, -4));
